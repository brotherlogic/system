...
type Bootstrap struct {
	...
	HaCluster *HACluster `protobuf:"bytes,1,opt,name=ha_cluster,json=haCluster,proto3" json:"ha_cluster,omitempty"`
}
...
func (x *Bootstrap) GetHaCluster() *HACluster {
	if x != nil {
		return x.HaCluster
	}
	return nil
...
func (x *HACluster) GetNodes() []*Node {
	if x != nil {
		return x.Nodes
	}
	return nil
...
var file_system_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x72, 0x6f, 0x74, 0x68, 0x65, 0x72, 0x6c, 0x6f, 0x67,
	0x69, 0x63, 0x2f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_system_proto_goTypes = []interface{}{
	(*Bootstrap)(nil), // 0: system.Bootstrap
	(*HACluster)(nil), // 1: system.HACluster
	(*Node)(nil),      // 2: system.Node
}
var file_system_proto_depIdxs = []int32{
	1, // 0: system.Bootstrap.ha_cluster:type_name -> system.HACluster
	2, // 1: system.HACluster.nodes:type_name -> system.Node
